    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200)),
                ('category', models.CharField(choices=[('tax', 'Tax Services'), ('customs', 'Customs Services'), ('trade', 'Trade Facilitation'), ('travel', 'Travel Services'), ('other', 'Other Services')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('citizen', 'Citizen'), ('staff', 'Staff'), ('admin', 'Administrator')], default='citizen', max_length=20)),
